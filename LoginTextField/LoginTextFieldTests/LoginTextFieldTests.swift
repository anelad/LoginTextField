...
class LoginTextFieldTests: XCTestCase {
    ...
    func testDefaultColor(){
        ...
        XCTAssertEqual(testView.imgView.tintColor, UIColor.black)
        ...
        XCTAssertEqual(testView.imgView.tintColor, color)
    ...
    func testHandlingErrors(){
        ...
        XCTAssertEqual(testView.imgView.tintColor, UIColor.red)
